...
import { HotelCollectionComponent } from "./components/hotel-collection.component";
...
export const HotelCollectionContainer = () => {
    const [hotelCollection, setHotelCollection] =
        React.useState<HotelEntityVm[]>(createMockHotelCollection)
